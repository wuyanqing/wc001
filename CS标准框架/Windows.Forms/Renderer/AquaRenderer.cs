...
namespace Windows.Forms
{
    ...
    public class AquaRenderer : ToolStripProfessionalRenderer
	{
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="Windows.Forms.ProfessionalColorTable"/> to be used for painting.</param>
        ...
        {
            ProfessionalColorTable colorTable = ColorTable as Windows.Forms.ProfessionalColorTable;
            if (colorTable != null)
            {
