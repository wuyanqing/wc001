    ...
    public class ExportExcel
    {
        ...
        public bool Export(DataGridView myview)
        {
            ...
            try
            {
                ...
                Microsoft.Office.Interop.Excel.Workbook MyWorkBook = MyWorkBooks.Add(Missing.Value);
                ...
                Microsoft.Office.Interop.Excel.Range MyRange = MyWorkSheet.get_Range("A1", column);
