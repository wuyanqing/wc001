...
namespace Dal
{
    ...
    public class DataBase
    {
        ...
        /// <param name="prams">命令参数</param>
        /// <returns>执行是否成功</returns>
        public bool TransactSql(DataBaseVisitor dbVistor, string sqlCommand, out int nReturnRows)
        {
            nReturnRows = 0;
            if ((false == Open()) || (null == dbVistor))
                return false;
        ...
        #region 用ExecuteNonQuery执行SQL语句(接口1重载4)
        /// <summary>
        /// 用ExecuteNonQuery执行SQL语句(重载2)
        /// </summary>
        /// <param name="dbVistor">访问类</param>
        ...
        #region 用ExecuteNonQuery执行SQL语句(接口2重载4)
        /// <summary>
        /// 用ExecuteNonQuery执行SQL语句(重载2)
        /// </summary>
        /// <param name="dbVistor">访问类</param>
        ...
        /// <param name="cmdText">sql语句</param>
        /// <returns>执行是否成功</returns>
        public bool TransactSql(string cmdText,out int nReturnRows)
        {
            bool Flag = false;
            nReturnRows = 0;
            if (!Open()) { return false; }
