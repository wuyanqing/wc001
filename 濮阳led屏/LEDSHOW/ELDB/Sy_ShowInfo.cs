...
namespace DataRabbit.HashOrm
{
	...
	public partial class Sy_ShowInfo //: IEntity<System.Int32>,IHashEntity
	{
		...
		public System.String ManyLine
		{
			get
			{
				if (this._PropertySet.ContainsKey(_ManyLine))
				{
					return (System.String)this._PropertySet[_ManyLine];
				}
			...
			set
			{
				if (this._PropertySet.ContainsKey(_ManyLine))
				{
					this._PropertySet.Remove(_ManyLine);
				}
				this._PropertySet.Add(_ManyLine, value);
		...
		public string[] ColNames
		{
			get
			{
				string[] strs = {_Id,_OrderMasterID,_OrderDetailID,_StorageID,_OperateType,_TobaccoName,_OperatePiece,_OperateItem,_ConfirmState,_ReadState,_HardwareReadState,_ManyLine};
				return strs;
			}
		}
		#endregion
